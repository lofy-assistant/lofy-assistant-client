      ...
      <div className="max-w-7xl mx-auto flex-1 grid grid-rows-1 grid-cols-1 h-[calc(100vh-6rem)]">
        <div className="relative z-10 self-center px-4 justify-self-start sm:px-6 md:px-8">
          <div className="space-y-2">
            <Badge variant="default" className="px-4 py-2 transition-all duration-300 border border-white shadow-lg bg-linear-to-r from-emerald-400/30 to-indigo-500/40 backdrop-blur-md hover:scale-105">
              <span className="text-xs text-transparent bg-linear-to-r from-emerald-800 to-indigo-800 bg-clip-text">✨ AI-Powered Productivity Application</span>
            </Badge>
            <div className="space-y-4">
              <h1 className="text-5xl font-bold leading-tight text-transparent lg:text-8xl bg-linear-to-r from-emerald-700/80 via-indigo-700/80 to-emerald-700 bg-clip-text">Lofy AI;</h1>
          ...
          <div className="flex flex-col gap-4 mt-10 sm:flex-row">
            <Link href={whatsappUrl} target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="px-8 py-6 text-lg transition-all duration-300 shadow-lg text-secondary bg-linear-to-r from-emerald-600/80 to-indigo-600/80 hover:shadow-xl hover:scale-105 cursor-pointer">
                Try Lofy Now
              </Button>
            </Link>
          </div>

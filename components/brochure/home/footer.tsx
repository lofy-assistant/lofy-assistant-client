      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-transparent bg-linear-to-r from-emerald-600 to-indigo-600 bg-clip-text">
              Lofy
            </h3>
            <p className="text-sm text-muted-foreground">
              Your AI-powered personal assistant that gets things done.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-8 mt-8 border-t border-border md:flex-row">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Lofy. All rights reserved.
          </p>

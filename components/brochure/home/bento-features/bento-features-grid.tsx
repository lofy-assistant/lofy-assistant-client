      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="mb-20 text-center">
          ...
          <p className="max-w-5xl mx-auto leading-relaxed text-gray-600 text-sm md:text-md text-justify md:text-center lg:text-lg">
            Lofy saves you time by letting you manage your work just by messaging it, with no app switching, all while understanding your context and working quietly in the background.
          </p>
        </div>

...
export default function AppsIntegrationPage() {
  const communicationChannels = [
    {
      name: "WhatsApp",
      icon: "/assets/bento-features/whatsapp-icon.svg",
    ...
    {
      name: "Telegram",
      icon: "/assets/bento-features/telegram-icon.svg",
    ...
    {
      name: "Slack",
      icon: "/assets/bento-features/slack-icon.svg",
    ...
    },
    {
      ...
      icon: "/assets/bento-features/msteams-icon.svg",
  ...
  const toolsIntegrations = [
    {
      ...
      icon: "/assets/bento-features/google-calendar-icon.svg",
    ...
    // {
    //   name: "Google Drive",
    //   icon: "/assets/bento-features/gdrive-icon.svg",
    ...
    {
      name: "Gmail",
      icon: "/assets/bento-features/gmail-icon.svg",
    ...
    {
      name: "Outlook",
      icon: "/assets/bento-features/outlook-icon.svg",
